...
export async function GET() {
  ...
  const niche = "pizzaria";
  const text =
    "Me chamo Matheus, trabalho com desenvolvimento de sistemas para pizzarias. Poderia me informar quem é o responsável pelo estabelecimento para eu falar diretamente sobre uma melhoria no delivery?";
  await pool
    .request()
